...
OUTPUT_PATH = './dataset/cleaned-corpus-harrier-600-tokenized-overlap.tsv'
TRANSLATION_PATH = './dataset/cleaned-idx-to-pid-harrier-600-overlap.json'

CHUNK_SIZE = 256 - 2 # Account for CLS and SEP
OVERLAP = 30
DOC_BATCH_SIZE = 1000
TOKENIZER_NAME = 'microsoft/harrier-oss-v1-0.6b'
NUM_PROCS = 24
MIN_TOKENS = 35
